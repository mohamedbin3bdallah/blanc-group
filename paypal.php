...
if(isset($_POST['id'],$_POST['phone'],$_POST['address'],$_COOKIE['business'],$_COOKIE['currency_code'],$_COOKIE['ipaddress']))
{
	...
	$result = $dbh->query("select id,product,title{$lang} as title,price,quantity from cart where id = '$id' and ipaddress = '$ip'");
...
$(document).ready(function(){
	$('#submitDiv').show(function(e) {
		var charset = 'utf-8';
		var cmd = '_xclick';
		var business = "<?php echo $_COOKIE['business']; ?>";
