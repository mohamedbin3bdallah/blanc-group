...
if(isset($_COOKIE['admin']))
{
	...
	if(isset($_POST['saveproduct']) && isset($_POST['categories']))
	{
		...
		{
			$folder = $_POST['oldid'];
			updateProduct($_POST['oldid'],$_POST['titleen'],$_POST['titlear'],$_POST['descriptionen'],$_POST['descriptionar'],implode("|",$_POST['categories']),implode(",",$_POST['sizes']),implode(",",$_POST['colors']),$_POST['oldprice'],$_POST['price'],$_POST['quantity']);
		}
		else
		{
			$folder = insertProduct($_POST['titleen'],$_POST['titlear'],$_POST['descriptionen'],$_POST['descriptionar'],implode("|",$_POST['categories']),implode(",",$_POST['sizes']),implode(",",$_POST['colors']),$_POST['oldprice'],$_POST['price'],$_POST['quantity']);
		}
