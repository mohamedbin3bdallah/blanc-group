...
$cart = getCarttByID($_GET['id'],$_COOKIE['ipaddress']);
if(isset($cart) && !empty($cart))
{
	$saleid = mt_rand(1000000000,9999999999);
	insertSale($saleid,$cart['product'],$cart['titleen'],$cart['titlear'],$cart['price'],$cart['quantity'],$cart['total'],$cart['color'],$cart['size'],$_GET['phone'],$_GET['address'],$ipaddress);
	deleteCart($_GET['id']);
