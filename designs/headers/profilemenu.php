					...
					<div class="tabbable">
						<div class="tab-content no-space">
							<div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-12 control-label list-label"><!--<i class="glyphicon glyphicon-option-horizontal"></i>--><a href="../pages/sizes.php"><?php language(" ").language("sizes"); ?></a></label>
								</div>
								<div class="form-group">
									<label class="col-md-12 control-label list-label"><!--<i class="glyphicon glyphicon-option-horizontal"></i>--><a href="../pages/colors.php"><?php language(" ").language("colors"); ?></a></label>
								</div>								
								<div class="form-group">
