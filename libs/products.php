...
function updateProduct($id,$titleen,$titlear,$descriptionen,$descriptionar,$categories,$sizes,$colors,$oldprice,$price,$quantity)
{
	include("../libs/config.php");
	include("../libs/opendb.php");
	$stmt = $dbh->prepare("update products set titleen = '$titleen',titlear = '$titlear',descriptionen = '$descriptionen',descriptionar = '$descriptionar',categories = '$categories',sizes = '$sizes',colors = '$colors',oldprice = '$oldprice',price = '$price',quantity = '$quantity' where id = '$id'");
	$stmt->execute();	
	include("../libs/closedb.php");
}

function insertProduct($titleen,$titlear,$descriptionen,$descriptionar,$categories,$sizes,$colors,$oldprice,$price,$quantity)
{
	include("../libs/config.php");
	include("../libs/opendb.php");
	$stmt = $dbh->prepare("insert into `products` (`titleen`,`titlear`,`descriptionen`,`descriptionar`,`categories`,`sizes`,`colors`,`oldprice`,`price`,`quantity`) values ('$titleen','$titlear','$descriptionen','$descriptionar','$categories','$sizes','$colors','$oldprice','$price','$quantity')");
	$stmt->execute();
